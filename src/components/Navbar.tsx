    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-surface-dim">
      <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
        <a href="/" className="flex items-center gap-2">
          <span className="text-lg font-semibold text-ink tracking-tight">Ibralogue</span>
          <span className="text-xs font-mono text-ink-faint bg-surface-muted px-1.5 py-0.5 rounded">{VERSION}</span>
        </a>
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <a
            ...
            className="text-ink-muted hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded transition-colors"
            aria-label="GitHub"
          >
        ...
        <button
          className="md:hidden text-ink-muted hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded transition-colors"
